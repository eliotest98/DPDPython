...
bytecode = ReadBytecode(debug_active=1)
...
bytecode.select_file(resource_directory + "\\GeneratedFiles\\DirectorySelected\\" + "AaronWard\\covidify" + "\\Source",
                     resource_directory + "\\GeneratedFiles\\Oracles\\" + "AaronWard\\covidify")
repository.delete_reporitory()
#bytecode.select_file(current_directory + "\\Oracle\\Test", resource_directory + "\\Oracles\\Test")
#
# Detectors
#
